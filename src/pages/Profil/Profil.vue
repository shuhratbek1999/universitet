     ...
     <div class="container">
         ...
         <div class="login_top">
              <div class="login_about">
                  <ul>
                    <li @click="Dashboard" class="dashboard" style="cursor: pointer">DASHBOARD</li>
                    <li @click="Hujjatlar">
              ...
              <div class="login_kirish">
                ...
                <div class="profil_about">
                    ...
                    <div class="profil_button">
                        <div class="border-2 border-solid rounded-lg p-2 text-center bg-slate-50 shadow hover:shadow-lg cursor-pointer tahrirlash" @click="Tahrirlash">
